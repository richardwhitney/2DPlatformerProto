...
public class CameraFollow : MonoBehaviour {
	...
	void LateUpdate() {
		...
		xPosition = Mathf.Clamp(xPosition, min.x + cameraHalfWidth, max.x - cameraHalfWidth);
		yPosition = Mathf.Clamp(yPosition, min.y + orthographicSize, max.y - orthographicSize);
